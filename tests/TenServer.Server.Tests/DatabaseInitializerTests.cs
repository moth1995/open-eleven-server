...
public sealed class DatabaseInitializerTests
{
    ...
    public async Task Upgrades_legacy_sqlite_account_authentication_columns()
    {
        var databaseFile = Path.Combine(
            Path.GetTempPath(), $"tenserver-legacy-{Guid.NewGuid():N}.db");
    ...
    {
        var databaseFile = Path.Combine(
            Path.GetTempPath(), $"tenserver-demo-cleanup-{Guid.NewGuid():N}.db");
    ...
    {
        var databaseFile = Path.Combine(
            Path.GetTempPath(), $"tenserver-demo-preserve-{Guid.NewGuid():N}.db");
