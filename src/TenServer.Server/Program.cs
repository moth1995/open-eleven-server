...
// ---------------------------------------------------------------------------
// Configuration: YAML file, an optional local override, then TENSERVER_-prefixed
// environment variables (TENSERVER_Server__Database__ConnectionString and friends).
// ---------------------------------------------------------------------------
...
{
    var log = app.Services.GetRequiredService<ILoggerFactory>().CreateLogger("TenServer.Startup");
