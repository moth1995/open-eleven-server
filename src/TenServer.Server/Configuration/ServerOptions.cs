...
{
    /// <summary>4-byte rolling XOR key, hex. PES2010: 5B9F2E64. PES5-family: A677957C.</summary>
    public string XorKey { get; set; } = "5B9F2E64";
...
public sealed class DatabaseOptions
{
    ...
    public string ConnectionString { get; set; } = "Data Source=data/tenserver.db";
